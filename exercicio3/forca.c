/*
    ...
    Author: Kaio Campos
    Date: 13/01/26 21:12
    Description: Programa que simula um jogo de forca.
*/
...
/* 3️⃣ Desenho da forca e da palavra */
void desenhaforca() {
...
/* 6️⃣ Verifica se perdeu */
int enforcou() {
    return chuteserrados() >= 5;
}

/* 7️⃣ Adicionar nova palavra */
void adicionapalavra() {
    char quer;
